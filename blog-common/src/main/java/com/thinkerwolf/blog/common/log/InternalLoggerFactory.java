package com.thinkerwolf.blog.common.log;

import com.thinkerwolf.blog.common.log.jdk.JdkLoggerFactory;

public abstract class InternalLoggerFactory {

    public static final String DEFAULT_LOGGER_FACTORY_CLASS_NAME = "com.thinkerwolf.blog.common.log.slf4j.Slf4jLoggerFactory";
            ...
            synchronized (InternalLoggerFactory.class) {
                if (defaultLoggerFactory == null) {
                    try {
                    	...
                    	System.err.println("Do not found default loggerFactory : " + DEFAULT_LOGGER_FACTORY_CLASS_NAME);
